      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex gap-3 items-center">
          ...
          <Link
            ...
            title="Have Claude pull stories / quotes / illustrations from a PDF, .txt, or pasted text"
          >
            ✨ Extract from source
          </Link>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex flex-wrap items-baseline gap-2">
                        ...
                        {r.auto_generated && (
                          <span
                            className="text-[10px] uppercase tracking-wide px-1.5 py-0.5 rounded bg-purple-100 text-purple-800"
                            title={
                              r.auto_source_label
                                ? `Auto-generated from: ${r.auto_source_label}`
                                : 'Auto-generated by Claude from a source'
                            }
                          >
                            ✨ Auto
                          </span>
