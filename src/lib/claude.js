...
export async function lookupScriptureNRSVUe(reference) {
  ...
  const result = await callClaude({
    system: [
      ...
      '',
      'COMPOSITE REFERENCES: after a semicolon or comma, a bare verse or',
      'verse-range INHERITS the book and chapter — "Genesis 37:6-7; 9"',
      'and "Genesis 37:6-7, 9" both mean verses 6, 7, and 9 of Genesis',
      '37 (NOT chapter 9). Include every listed verse, in order, run',
      'together as continuous prose.',
      '',
